...
def file_console_log():
    """ Return a logger handling two different streams:
        ...
        * the console stdout stream, in which all events
          are displayed.
    """
    logger = logging.getLogger(__name__)  # new logger object
    ...
    # Stream handler: display all events in the console
    stream_handler = logging.StreamHandler()
    stream_handler.setLevel(logging.DEBUG)  # all messages will de displayed
    stream_handler.setFormatter(formatter)  # apply format
